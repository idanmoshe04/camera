...
//אחרי טעינה של העמוד אני רוצה לבצע בדיקה האם אני יכול לבצע התקנה
document.addEventListener("DOMContentLoaded", function (event) {
    //אם זוהה שאפשר לעדכין אז הוא מוציא את האירוע של beforeinstll
...
function installApp() {
    ...
    // נציג את חלונית ההתקנה שדרכה אומרים ךדפדף לעדכן את האפליקציה מקומית
